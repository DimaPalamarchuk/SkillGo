...
namespace SkillGo.Migrations
{
    ...
    [Migration("20260308171908_AddChatNotification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillGo.Data.Models.Chat.Conversation", b =>
                {
                    ...
                    b.Property<DateTime?>("LastReadByUserAAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("LastReadByUserBAtUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SkillGo.Data.Models.Chat.Message", b =>
                {
                    ...
                    b.Property<bool>("IsOrderDelivery")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SkillGo.Data.Models.Orders.OrderDispute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SkillGo.Data.Models.Reports.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SkillGo.Data.Models.UserBan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SkillGo.Data.Models.Chat.Message", b =>
                {
                    ...
                    b.HasOne("SkillGo.Data.Models.Orders.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("SkillGo.Data.Models.UserBan", b =>
                {
                    b.HasOne("SkillGo.Data.ApplicationUser", "CreatedByUser")
                        .WithMany()
